...
import { DATA_FOLDER, SCORES_FILENAMES } from '../../../config/constants.js';
import { analyzeGameStats, displayGameStats } from './gameAnalyzer.js';
import { analyzeMatchStats, displayMatchStats as showMatchStats } from './matchAnalyzer.js';
...
runMatchAnalysis(SCORES_FILENAMES);
