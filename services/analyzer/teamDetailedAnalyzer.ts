...
/**
 * Анализирует детальную статистику команды
 */
export function analyzeTeamDetailedStats(matches: Match[], teamName: string): TeamDetailedStats {
...
/**
 * Выводит детальную статистику команды
 */
export function displayTeamDetailedStats(stats: TeamDetailedStats, teamName: string): void {
    console.log('\n========== ДЕТАЛЬНАЯ СТАТИСТИКА КОМАНДЫ ==========');
